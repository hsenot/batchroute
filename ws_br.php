<?php
	...
	while (!feof($fr) ) {
		...
		else
		{
			...
			$url = "http://open.mapquestapi.com/directions/v1/route?outFormat=json&from=".$line_of_text[2].",".$line_of_text[1]."&to=".$line_of_text[4].",".$line_of_text[3]."&shapeFormat=cmp&generalize=0";
		}
		//echo $url;
